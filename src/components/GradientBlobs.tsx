  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, oklch(0.62 0.22 264 / 0.55), transparent)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, oklch(0.5 0.27 305 / 0.55), transparent)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, oklch(0.45 0.25 285 / 0.5), transparent)",
        }}
      />
      {/* floating sphere */}
      <div
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 30%, white, oklch(0.5 0.27 305))",
        }}
      />
    </div>
  );
